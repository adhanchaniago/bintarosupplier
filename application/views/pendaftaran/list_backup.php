...
<div class="row">
      ...
      <div class="col-md-7">
         <div class="form-group">
           <input type="file" name="foto1" id="uploadImage" required>
           <div class="col-md-5 div_image"></div>
         </div>
       </div>
       ...
       <div class="col-md-7">
          <div class="form-group">
            <input type="file" name="foto2" id="uploadImage2" required>
            <div class="col-md-5 div_image2"></div>
          </div>
        </div>

        <div class="col-md-3">
          <label>Upload Foto STNK  <span class="text-danger">*</span></label>
        </div>
        <div class="col-md-7">
           <div class="form-group">
             <input type="file" name="foto3" id="uploadImage3" required>
             <div class="col-md-5 div_image3"></div>
           </div>
         </div>

         <div class="col-md-3">
           <label>Upload Foto SKCK  <span class="text-danger">*</span></label>
         </div>
         <div class="col-md-7">
            <div class="form-group">
              <input type="file" name="foto4" id="uploadImage4" required>
              <div class="div_image4"></div>
            </div>
          </div>
          ...
          <div class="col-md-7">
             <div class="form-group">
               <input type="file" name="foto5" id="uploadImage5" required>
               <div class="div_image5"></div>
             </div>
           </div>
